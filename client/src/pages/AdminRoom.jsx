      ...
      <div className="relative mb-4 shrink-0">
        ...
        {isHost ? (
          <button
            ...
            className="absolute bottom-12 right-2 flex h-9 w-9 items-center justify-center rounded-full bg-zinc-800/90 text-lg shadow hover:bg-zinc-700"
            title="发红包"
          >
      ...
      <div className="flex flex-1 flex-col gap-6">
        ...
        {isHost ? (
          <div className="rounded-lg bg-zinc-800 px-4 py-3 text-center">
            ...
            <div className="mt-1 text-xs text-zinc-500">V1.0.111</div>
          </div>
        ) : null}
